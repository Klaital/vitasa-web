...
class SignupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post signups_url, params: { signup: { date: @signup.date, site_id: @signup.site_id, user_id: @signup.user_id } }
    end
  ...
  test "should update signup" do
    patch signup_url(@signup), params: { signup: { date: @signup.date, site_id: @signup.site_id, user_id: @signup.user_id } }
